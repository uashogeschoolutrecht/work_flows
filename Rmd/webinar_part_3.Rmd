...
## Exploring the tools to do (Open) Data Science at HU
 ...
 >- Introducing the tools; Github - HU ResearchDrive - RStudio trinity
 >- Introducing RStudio and the `{tidyverse}`
 >- Getting materials from Github
 >- Getting access to HU ResearchDrive
 >- (Getting access to HU ResearchDrive from within RStudio)
...
## Getting the code into you environment; introducing the jargon {.build}
...
## Github user-account
 ...
 >- Adding a README to each repo is a good idea
 >- The HU Github repos: https://github.com/uashogeschoolutrecht  
 
## Fork the spiegelhalter "ArtOfStatistics" repo

 - Seach *spiegelhalter* in Github.com
 - https://github.com/dspiegel29/ArtofStatistics
 - Go to repo "ArtOfStatistics"
 - Click **"Fork"** button
...
## Getting the slides is easy now!

 >- Fork https://gihub.com/uashogeschoolutrecht/work_flows
 >- Clone this "Forked" repo to your RStudio Env.
 >- The slides are in "./Rmd"
 >- This repo contains all content from the webinars
 >- My code will work from a cloned github repo in an RSTudio Project, how?

## Be relative!
[Use the `{here}` package!](https://github.com/jennybc/here_here) 

_Stop using `setwd()`!!!_

```{r, echo=TRUE}
## relative path 
file.path("Rmd", "webinar_part_2.html")
## the actual path
here::here("Rmd", "webinar_part_2.html")
```
